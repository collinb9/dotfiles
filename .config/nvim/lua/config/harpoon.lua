...
vim.api.nvim_set_keymap('n', '<leader>tc', ':lua require("harpoon.cmd-ui").toggle_quick_menu()<CR>', {noremap = true, silent = true} )
...
vim.api.nvim_set_keymap('n', '<leader>tu', ':lua require("harpoon.term").gotoTerminal(1)<CR>', {noremap = true, silent = true} )
vim.api.nvim_set_keymap('n', '<leader>te', ':lua require("harpoon.term").gotoTerminal(2)<CR>', {noremap = true, silent = true} )
